...
export default {
  ...
  methods: {
    ...
    mint () {
      this.erc20Contract.methods.mint(this.userAddr, new BigNumber(100).times(1e18))
    ...
    transfer () {
      this.erc20Contract.methods.transfer(this.inputDestAddr, new BigNumber(this.inputAmount).times(1e18))
